...
class TestInventoryManager(unittest.TestCase):
    ...
    def test_sell_product(self):
        ...
        self.assertEqual(self.inventory_manager.list_products()[self.pantalon.name]._quantity, 3)
    ...
    def test_restock_product(self):
        ...
        self.inventory_manager.restock_product(self.chaise.name, 5)
        self.assertEqual(self.inventory_manager.list_products()[self.chaise.name]._quantity, 15)
    ...
    def test_get_product(self):
        ...
        """
        self.inventory_manager.add_product(self.chaise, 5)
        chaise_copy = self.inventory_manager.get_product(self.chaise.name)
        self.assertEqual(self.chaise, chaise_copy)
